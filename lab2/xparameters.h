...
/* Definitions for peripheral DIPS_PUSH */
#define XPAR_DIPS_PUSH_BASEADDR 0x81420000
#define XPAR_DIPS_PUSH_HIGHADDR 0x8143FFFF
#define XPAR_DIPS_PUSH_DEVICE_ID 1
#define XPAR_DIPS_PUSH_INTERRUPT_PRESENT 0
#define XPAR_DIPS_PUSH_IS_DUAL 0
